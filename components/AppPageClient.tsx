...
const CreateAccountModal = dynamic(() => import('@/components/modals/CreateAccountModal').then(mod => mod.CreateAccountModal), {
  ssr: false,
  loading: () => null
});

const CreateStrategyModal = dynamic(() => import('@/components/modals/CreateStrategyModal').then(mod => mod.CreateStrategyModal), {
  ssr: false,
  loading: () => null
});

const AccountsView = dynamic(() => import('@/components/views/AccountsView').then(mod => mod.AccountsView), {
  ssr: false,
  loading: () => <Card className="w-full"><CardBody className="h-24 animate-pulse" /></Card>
});

const PairsView = dynamic(() => import('@/components/views/PairsView').then(mod => mod.PairsView), {
  ssr: false,
  loading: () => <Card className="w-full"><CardBody className="h-24 animate-pulse" /></Card>
});
